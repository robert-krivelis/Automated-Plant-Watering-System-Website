...
public class FoodBankManager {
    ...
    public ArrayList<ClientTypes> clientRequirementsByType;
    ...
    public void generateOrder() {
        for (ArrayList<Integer> hamperClients : this.allClientTypesFromUser) {
            try {
                // hamperCreator only does one at a time. FoodBankManager creates multiple
                // hampers.
        ...
        // // creates hamper creator object and inputs client configuration for the
        // hamper
